...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_GalleryItems_vue__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Participate_vue__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_ModifyImage_vue__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_RegistrationForm_vue__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_FinishModifyingScreen_vue__ = __webpack_require__(61);
...
var VueAxios = __webpack_require__(38);
...
new Vue({
    ...
    components: {
        ...
        modifyimage: __WEBPACK_IMPORTED_MODULE_3__components_ModifyImage_vue___default.a,
        finishmodifyingimage: __WEBPACK_IMPORTED_MODULE_5__components_FinishModifyingScreen_vue___default.a,
        registration: __WEBPACK_IMPORTED_MODULE_4__components_RegistrationForm_vue___default.a
    },
    methods: {
        likeItem: function likeItem(id, success, fail) {
        ...
        insertMoreDataToList: function insertMoreDataToList(searchText) {
        ...
        loadMoreData: function loadMoreData(success, error) {
            console.log('Gallery - loadMoreData');
            var offset_id = this.currentOffset;
            var limit = this.limit;

            var queryString = "?itemOffsetId=" + offset_id + "&itemLimit=" + limit;
        ...
        loadData: function loadData(queryString, success, error, refresh) {
            console.log('Gallery - loadData');
            if (queryString === null || queryString === undefined || queryString === '') {
                return false;
            }
            var apiUrl = this.apiUrl + "gallery/index";
...
Component.options.__file = "resources/js/components/GalleryItems.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-300d7f0e", Component.options)
  } else {
    hotAPI.reload("data-v-300d7f0e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_mugen_scroll__ = __webpack_require__(44);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        MugenScroll: __WEBPACK_IMPORTED_MODULE_0_vue_mugen_scroll___default.a
    },
    data: function data() {
        return {
            modalData: 0,
    ...
    methods: {
        ...
        showModal: function showModal(msg) {
            ...
            this.$nextTick(function () {
                $(".modal-wrapper").css("top", _this2.fromTop + 'px');
                console.log(_this2.fromTop);
            });
        },
        ...
        likeError: function likeError(e) {
            if (e) {
                ...
                var array = {
                    'type': '',
                    'msg': "Da biste glasali morate se registrovati i popuniti podatke <a href=" + _baseUrl + "/Gallery/gallery/participate>ovde</a>."
                };
        ...
        likeSuccess: function likeSuccess(id) {
            if (typeof id.item_id !== 'undefined') {
                ...
                var array = {
                    'type': '',
                    'msg': "Da biste glasali morate se registrovati i popuniti podatke <a href=" + _baseUrl2 + "/Gallery/gallery/participate>ovde</a>."
                };
                this.showModal(array);
            }
        },
        fbShare: function fbShare(id) {
            var url = baseUrl + "/Gallery/gallery/share/" + id;
        ...
        fetchData: function fetchData() {
            ...
            $(window).bind('mousewheel DOMMouseScroll', function (event) {
                if (event.originalEvent.wheelDelta > 0 || event.originalEvent.detail < 0) {} else {
                    if (event.clientY + 1300 > $(document).height()) {
                        _this.loading = true;
                        var _searchValue = $(".gallery-search").val();
                        _this.$parent.insertMoreDataToList(_searchValue);
                        _this.loading = false;
                    }
                }
            });
            ...
            document.addEventListener('touchmove', function (e) {
                ...
                if (touch.pageY + 1300 > $(document).height()) {
                    _this.loading = true;
                    var _searchValue2 = $(".gallery-search").val();
                    _this.$parent.insertMoreDataToList(_searchValue2);
                    _this.loading = false;
                }
            }, false);
        },
...
var throttle = _interopDefault(__webpack_require__(45));
        ...
        [
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-lg-12" }, [
              _c("div", { staticClass: "col-sm-2 col-xs-2 show-on-mob" }, [
                _vm._v("\n                     \n                ")
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "col-sm-10 col-xs-10" }, [
                _c(
                  "a",
                  {
                    attrs: {
                      href: _vm.$parent.baseUrl + "/Gallery/gallery/landing"
                    }
                  },
          ...
          _c("div", { staticClass: "row" }, [
            ...
            _c("div", { staticClass: "col-lg-4 col-md-4" }, [
              _c(
                ...
                {
                  attrs: {
                    href: _vm.$parent.baseUrl + "/Gallery/gallery/index"
                  }
                },
                [
                  _c("img", {
                    staticClass: "img-responsive show-imgt",
                    staticStyle: { margin: "0 auto" },
                    attrs: {
                      src: _vm.$parent.baseUrl + "/images/btn_galerija.png"
                    }
                  })
                ]
              )
                        ...
                        _c("div", { staticClass: "rotate-wrapper" }, [
                          _c(
                            ...
                            [
                              _c(
                                "div",
                                { staticClass: "gallery-img-wrapper" },
                                [
                                  _c("img", {
        ...
        ? _c(
            ...
            [
              this.$parent.moreItems === 1 && this.$parent.appItems.length > 6
                ...
                : _c("div", { staticClass: "end-of-data" }, [
        ...
        ? _c(
            ...
            [
              ...
              _c("div", { attrs: { slot: "body" }, slot: "body" }, [
                _c("span", {
                  domProps: { innerHTML: _vm._s(_vm.modalData.msg) }
                })
              ]),
              _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-300d7f0e", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/Participate.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2629cbc3", Component.options)
  } else {
    hotAPI.reload("data-v-2629cbc3", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(14)("17f8b268", content, false, {});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2629cbc3", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/ModifyImage.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7c2d5726", Component.options)
  } else {
    hotAPI.reload("data-v-7c2d5726", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        this.$parent.$on('loadImageToCanvas', function (image, firstName, lastName, email, livingPlace) {
            ...
            fabric.Image.fromURL(uploadedImage, function (img) {
                ...
                var scaleW = containerWidth / img.width;
                var scaleH = containerHeight / img.height;
                var scale = 0;
    ...
    methods: {
        ...
        selectSticker: function selectSticker(myImg) {
            var self = this;
        ...
        uploadModitiedImage: function uploadModitiedImage() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(this.$parent.apiUrl + 'gallery/store', formData, config).then(function (response) {
                _this2.button = _this2.$t('gallery.participate.upload_success_btn');
                _this2.image = '';
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7c2d5726", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-07bb2108", Component.options)
  } else {
    hotAPI.reload("data-v-07bb2108", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
          ...
          _c(
            ...
            [
              _c("div", { staticClass: "row" }, [
                _c(
                  "div",
                  { staticClass: "col-lg-6 col-md-6 col-sm-12 col-center" },
                  [
                    _c("br"),
                    _vm._v(" "),
                    _c("div", { staticClass: "input-wrapper" }, [
                        ...
                        directives: [
                          {
                            ...
                            value: {
                              required: true,
                              regex: /^[\w\sčćđžšČĆŠĐŽ]{2,32}$/
                            },
                            expression:
                              "{required: true, regex: /^[\\w\\sčćđžšČĆŠĐŽ]{2,32}$/}"
                          }
                        ],
                        staticClass: "form-input firstName",
                        attrs: {
                        ...
                        directives: [
                          {
                            ...
                            value: {
                              required: true,
                              regex: /^[\w\sčćđžšČĆŠĐŽ]{2,50}$/
                            },
                            expression:
                              "{required: true, regex: /^[\\w\\sčćđžšČĆŠĐŽ]{2,50}$/}"
                          }
                        ],
                        staticClass: "form-input address",
                        attrs: {
                        ...
                        directives: [
                          {
                            name: "show",
                            rawName: "v-show",
                            value: _vm.errors.has("livingPlace"),
                            expression: "errors.has('livingPlace')"
                          }
                        ],
                        staticClass: "validation-text"
                      },
                      [_vm._v(_vm._s(_vm.errors.first("livingPlace")))]
                    ),
                    _vm._v(" "),
                    _c("br"),
                    _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "button-row" }, [
      _c("button", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-07bb2108", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/FinishModifyingScreen.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e5b876f4", Component.options)
  } else {
    hotAPI.reload("data-v-e5b876f4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e5b876f4", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(14)("b6fef8a4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
