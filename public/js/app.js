    ...
    methods: {
        ...
        likeError: function likeError(e) {
            if (e) {
                ...
                var array = {
                    'type': '',
                    'msg': "Da biste glasali morate se registrovati i popuniti podatke <a href=" + _baseUrl + "/gallery/participate>ovde</a>."
                };
        ...
        likeSuccess: function likeSuccess(id) {
            if (typeof id.item_id !== 'undefined') {
                ...
                var array = {
                    'type': '',
                    'msg': "Da biste glasali morate se registrovati i popuniti podatke <a href=" + _baseUrl2 + "/gallery/participate>ovde</a>."
                };
                this.showModal(array);
            }
        },
